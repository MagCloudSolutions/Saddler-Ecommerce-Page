        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="inner-content">
                    <h2>Bell Boots</h2>
                    <span>Protect your horse's hooves with our sturdy and reliable bell boots.</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="right-content">
                    ...
                    <!-- <h4>Introduction:</h4> -->
                    <span style="line-height:25px">Bell boots are a type of protective horse gear that are designed to protect your horse's hooves from injury. 
                    Our selection of bell boots is made from high-quality materials, ensuring both durability and comfort for your horse.</span>
                    ...
                    <li><span>Protects your horse's hooves from injury during riding or turnout</span></li>
                    <li><span>Helps to prevent overreaching or interference while riding</span></li>
                    </ul>
                    <h4>Product Variations:</h4>
                    <ul><li>
                    <span><strong>Overreach Boots:</strong> Perfect for simple protection during turnout or riding</span></li>
                    <li><span><strong>Sport Boots:</strong> Ideal for high-impact activities such as jumping or cross-country riding</span></li>
                    <li><span><strong>Classic Bell Boots:</strong> A timeless design that provides full coverage for your horse's hooves</span></li>
                    </ul>
                </div>
            </div>
        </div>
